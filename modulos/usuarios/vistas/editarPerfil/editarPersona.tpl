...
{foreach from=$perfil item=persona}
                    ...
                    <div class="col l12">
                        ...
                        <div class="col s12 m12 l12">
                            ...
                            <form  method="post" class="formulario">
                                ...
                                <input type="hidden" value="{$datos_persona.index_ocupacion|default:"0"}" name="index_ocupacion" />
                                ...
                                <div class="col s12 m6 l6">
                                    ...
                                    <div class="input-field">
                                        ...
                                        <input id="primer_nombre" type="text" name="primer_nombre" class="validate" value="{$datos_persona.primer_nombre|default:"{$persona.nombre1}"}">
                                        <label for="primer_nombre">Primer Nombre</label>
                                    </div>

                                    <div class="input-field">
                                        <i class="mdi-action-perm-identity prefix"></i>
                                        <input id="segundo_nombre" type="text" name="segundo_nombre" class="validate" value="{$datos_persona.segundo_nombre|default:"{$persona.nombre2}"}">
                                        <label for="segundo_nombre">Segundo Nombre</label>
                                    </div>

                                    <div class="input-field">
                                        <i class="mdi-action-perm-identity prefix"></i>
                                        <input id="primer_apellido" type="text" name="primer_apellido" class="validate" value="{$datos_persona.primer_apellido|default:"{$persona.apellido1}"}">
                                        <label for="primer_apellido">Primer Apellido</label>
                                    </div>

                                    <div class="input-field">
                                        <i class="mdi-action-perm-identity prefix"></i>
                                        <input id="segundo_apellido" type="text" name="segundo_apellido" class="validate" value="{$datos_persona.segundo_apellido|default:"{$persona.apellido2}"}">
                                ...
                                <div class="col s12 m6 l6">
                                    ...
                                    <div class="input-field " >
                                        ...
                                        <input type="date" required class="datepicker" id="fecha_nac" name="fecha_nac" value="{$datos_persona.fecha_nac|default:"{$persona.fecha_nac}"}">
                                    </div>

                                    <div class="input-field">
                                        <select id="genero" name="genero" >
                                             <option value="{$persona.genero}">{if $persona.genero eq "M"}Masculino
                                                 {else} Femenino
                                                 {/if}
                                             </option>
                                            {if $persona.genero eq "M"}
                                    ...
                                    <div class="input-field">
                                        <select id="ocupacion"name="ocupacion">
                                            <option value="{$persona.ocupacion}">{$persona.ocupacion}</option>
                                    ...
                                    <div class="input-field ">
                                        <select id="ciudades" name="recidencia" >
                                             <option value="{$persona.recidencia|default:$persona.recidencia}" class="active">{$persona.ciudad}</option>
                                ...
                                <div class="input-field col s12 m12 l12">
                                    <textarea id="descripcion" class="materialize-textarea" name="descripcion">{$datos_persona.descripcion|default:"{$persona.descripcion}"}</textarea>
