<?php /* Smarty version Smarty-3.1.8, created on 2015-07-06 07:23:12
         compiled from "/opt/lampp/htdocs/whatido/modulos/usuarios/vistas/perfilUsuario/perfil.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1384375279558c1ada53eb46-90721218%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8865fae5627530478902c43d3bbbeb913d9c8ff7' => 
    array (
      0 => '/opt/lampp/htdocs/whatido/modulos/usuarios/vistas/perfilUsuario/perfil.tpl',
      1 => 1436158588,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1384375279558c1ada53eb46-90721218',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_558c1ada5aaed4_82295780',
  'variables' => 
  array (
    'layoutParametros' => 0,
    'mensaje' => 0,
...
<?php if ($_valid && !is_callable('content_558c1ada5aaed4_82295780')) {function content_558c1ada5aaed4_82295780($_smarty_tpl) {?><section class="ventana_emergente">
    <!--Fondo Oscuro Vista-->
    <div class="fondo">
                    ...
                    <div class="col l12">
                        ...
                        <div class="col s12 m12 l12">
                            ...
                            <form  method="post" class="formulario">
                                ...
                                <input type="hidden" id="prueba" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_persona']->value['index_ocupacion'])===null||$tmp==='' ? "0" : $tmp);?>
...
">
                                ...
                                <div class="col s12 m6 l6">
                                    ...
                                    <div class="input-field " >
                                        ...
                                        <input type="date" required class="datepicker" id="fecha_nac" name="fecha_nac" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_persona']->value['fecha_nac'])===null||$tmp==='' ? '' : $tmp);?>
">
                                    </div>
                        ...
                        <div class="col s12 m12 l12">
                            ...
                            <form  method="post" class="formulario">
                                <input type="hidden" value="1" name="empresa" />
                                 <input type="hidden"  value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['index_dpto2'])===null||$tmp==='' ? "0" : $tmp);?>
" name="index_dpto2" />
                                <input type="hidden"  value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['index_ciudad2'])===null||$tmp==='' ? "0" : $tmp);?>
" name="index_ciudad2" />
...
" name="index_naturaleza" />
                                <div class="col s12 m6 l6">
                                    ...
                                    <div class="input-field">
                                        <input id="nombre" type="text" name="nombre" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['nombre'])===null||$tmp==='' ? '' : $tmp);?>
">
                                        <label for="nombre">Razón Social</label>
                                    </div>

                                    <div class="input-field">
                                        <input id="sigla" type="text" name="sigla" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['sigla'])===null||$tmp==='' ? '' : $tmp);?>
">
...
"><?php echo $_smarty_tpl->tpl_vars['departamento']->value['nombre'];?>
                                ...
                                <div class="col s12 m6 l6">
                                    ...
                                    <div class="input-field">
                                        <input id="contacto" type="text" name="contacto" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['contacto'])===null||$tmp==='' ? '' : $tmp);?>
">
                                        <label for="contacto">Nombre Asesor</label>
                                    </div>

                                    <div class="input-field">
                                        <input id="telefono" type="text" pattern='[0-9]<?php echo '{7,10}';?>
' name="telefono" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['telefono'])===null||$tmp==='' ? '' : $tmp);?>
">
                                        <label for="telefono">telefono</label>
                                    </div>

                                    <div class="input-field">
                                        <input id="celular" type="text" pattern='[0-9]<?php echo '{7,10}';?>
' name="celular" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['celular'])===null||$tmp==='' ? '' : $tmp);?>
">
                                        <label for="celular">celular</label>
                                    </div>

                                    <div class="input-field">
                                        <input id="direccion" type="text" name="direccion" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['direccion'])===null||$tmp==='' ? '' : $tmp);?>
">
                                        <label for="direccion">Direccion</label>
                                    </div>

                                    <div class="input-field">
                                        <input id="email" type="text" name="web_site" placeholder="http://ejemplo.xxx" class="validate" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['web_site'])===null||$tmp==='' ? '' : $tmp);?>
">
                                ...
                                <div class="input-field col s12 m12 l12">
                                    <textarea id="descripcion" class="materialize-textarea" name="descripcion"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos_empresa']->value['descripcion'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
                                    <label for="descripcion">Acerca De Mi</label>
                                </div>
